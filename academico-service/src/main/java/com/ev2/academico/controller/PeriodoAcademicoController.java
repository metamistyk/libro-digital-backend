...
public class PeriodoAcademicoController {
    ...
    @PostMapping
    public PeriodoAcademicoResponseDTO guardar(
            @Valid @RequestBody
            PeriodoAcademicoRequestDTO periodoAcademicoRequestDTO) {

        return periodoAcademicoService.guardar(
                periodoAcademicoRequestDTO);
    }
    ...
    @GetMapping("/{id}")
    public PeriodoAcademicoResponseDTO buscarPorId(
    ...
    public PeriodoAcademicoResponseDTO actualizar(
        ...
        return periodoAcademicoService.actualizar(
                id,
                periodoAcademicoRequestDTO);
    }
